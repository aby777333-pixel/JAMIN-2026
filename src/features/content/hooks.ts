...
export const CONTENT_DEFAULTS: Record<string, string> = {
  ...
  'home.show_sold': 'on',
  'home.show_digest': 'on',
  'tour.slide1_title': 'Find verified land & plots',
  'tour.slide1_body': 'Browse live inventory, compare, calculate EMI and book site visits — all in one app.',
  'tour.slide2_title': 'Negotiate & buy with confidence',
  'tour.slide2_body': 'Make offers, get counter-offers, track your bookings and payments transparently.',
  'tour.slide3_title': 'Earn with your network',
  'tour.slide3_body': 'Partners get a digital business card, AI marketing studio and commission tracking.',
