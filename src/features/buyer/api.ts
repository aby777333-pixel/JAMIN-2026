...
const LIST_SELECT =
  'id, plot_code, price, status, media, attrs, coordinates, approval_status, verified_seller, verified_documents, verified_location, is_premium, seller_id, created_at, project:projects(name,code,location,rera_number,rera_status,rera_valid_till,neighborhood), type:property_types(slug,name)';
